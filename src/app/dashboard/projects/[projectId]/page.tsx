    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col">
      ...
      <div className="px-6 py-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-3xl font-bold text-gray-900">{serviceCount}</span>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-3xl font-bold text-gray-900">{dependencyCount}</span>
            </div>
            <p className="text-sm text-gray-600 font-medium">Dependencies</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-3xl font-bold text-gray-900">{hardDeps}</span>
            </div>
            <p className="text-sm text-gray-600 font-medium">Hard Dependencies</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-3xl font-bold text-gray-900">{softDeps}</span>
            </div>
            <p className="text-sm text-gray-600 font-medium">Soft Dependencies</p>
          </div>
        </div>
      </div>
      ...
      <main className="flex-1 px-6 pb-6">
        <div className="max-w-7xl mx-auto h-full">
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200 overflow-hidden h-[calc(100vh-350px)] min-h-[500px]">
